...
(function() {
    ...
    function declareOptions(scope) {
        const isMobileOrIOS = (typeof navigator !== 'undefined' && (/iPad|iPhone|iPod|Android|webOS|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || (navigator.maxTouchPoints && navigator.maxTouchPoints > 2)));
        ...
        scope.ReloadPlayerAfterAd = !isMobileOrIOS;// After the ad finishes do a player reload instead of pause/play
        ...
        scope.PlayerBufferingFix = !isMobileOrIOS;// If true this will pause/play the player when it gets stuck buffering
